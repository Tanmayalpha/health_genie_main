...
class VerificationSignUp extends StatefulWidget {
  const VerificationSignUp({super.key,  this.mobile});
  final String? mobile ;

  @override
  State<VerificationSignUp> createState() => _VerificationSignUpState();
}
...
class _VerificationSignUpState extends State<VerificationSignUp> {
                  ...
                  onPress: (){
                    if (otp == null) {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>  const SignUpFinalScreen()),
                      );
                      verifyApi();
                    }
  ...
  Future<void> verifyApi() async {
    ...
    apiBaseHelper.postAPICall(getSignVerifyOtp, parm).then((getData) {
