...
import 'package:health_genie/screens/DEVICE_sCREEN/service_tile.dart';
...
class _DeviceScreenState extends State<DeviceScreen> {
  ...
  void initState() {
    ...
    _isConnectingOrDisconnectingSubscription = widget.device.isDiscoveringServices.listen((value) {
  ...
  List _buildServiceTiles(BuildContext context, BluetoothDevice d) {
    return _services
        .map(
          (s) => ServiceTile(
            service: s,
